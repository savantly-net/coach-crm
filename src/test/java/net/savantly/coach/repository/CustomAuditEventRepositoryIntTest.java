...
import net.savantly.coach.config.audit.AuditEventConverter;
import net.savantly.coach.domain.PersistentAuditEvent;
...
import static net.savantly.coach.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
